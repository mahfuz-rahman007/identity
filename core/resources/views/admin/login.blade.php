      ...
      <div class="card-body login-card-body text-center">
        ...
        <form action="{{ route('admin.auth') }}" method="POST">
          ...
          <div class="input-group mb-3">
            <input type="text" class="form-control" name="username" value="admin" placeholder="{{ __('Username') }}">
          ...
          <div class="input-group mb-3">
            <input type="password" class="form-control" name="password" value="adminpass" placeholder="{{ __('Password') }}">
            <div class="input-group-append">
              <div class="input-group-text">
